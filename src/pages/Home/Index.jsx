  ...
  return (
    ...
    <div className="container">
      <header className="header">
        ...
        <button className="button_type_01" style={{display:'flex',gap:"5px"}} onClick={()=>{handleLinkedInLogin()}}>
        {loggedUser ? "My Account →" : (isSmallScreen ? (
            <>
      ...
      <footer className="footer">
        ...
        <button onClick={()=>{handleLinkedInLogin()}} className="button_type_01">
          {" "}
          {loggedUser ? (
            "My account →"
          ) : (
